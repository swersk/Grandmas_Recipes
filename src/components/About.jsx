...
export default function About() {
  ...
  return (
    <>
      <div className="content-wrapper border-2 border-red-300 flex h-screen">
        <img
        ...
        <div className=" text-black text-start">
          ...
          <span className="font-satoshi-regular text-xl">
            ...
            Ridge, Brooklyn. Growing up she watched her mother Lucy cook in the
            kitchen. Infused with love, care, and Italian authenticity in
            ...
            <br />
            <br />
            Grandma Jeanette learned from the best, while adding her own twist.
            For example, she cuts string beans with a scissor and not by hand.
            Grandma Lucy might call that 'wasteful' but we might just say that
            Grandma is modern. 😊
            <br />
            <br />
            It's the blessing of a lifetime to enjoy cooking with my grandma and
            to learn from someone who knows the kitchen so well. With this
