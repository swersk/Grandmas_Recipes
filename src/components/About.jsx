  ...
  return (
    <>
      <div className="flex">
        ...
        <span className="font-dancing-bold text-5xl">Welcome </span> <span className="font-satoshi-bold text-2xl">to this cherished, hidden corner of the internet! This page celebrates the cooking of our wonderful Grandma Jeanette.
          <br /><br />
